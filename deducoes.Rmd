...
ggplot(df, aes(genótipos, fenótipos)) + geom_point() + geom_hline(yintercept = 0) + theme_bw() + 
...
Note que o valor entre conchetes é exatamete o efeito de substituição ($\alpha$). Podemos fazer a mesma conta para o alelo B, e vamos econtrar que o efeito médio do alelo B ($\alpha_B$) é:
